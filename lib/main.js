...
exports.main = function() {
    ...
    function buildURLCMItem () {
        c2jURLItem = cm.Item({
            ...
            contentScriptFile: [data.url('coffeescript/extras/coffee-script.js'), data.url('convert.js'), data.url('convert-click.js'), data.url('convert-by-url.js')],
            ...
            case 'auto_convert_coffee_files':
                ...
                if (prefs[pref]) {
                    c2jURLItem = pageMod.PageMod({
                        ...
                        contentScriptFile: [data.url('coffeescript/extras/coffee-script.js'), data.url('convert.js'), data.url('convert-by-pagemod.js')],
    ...
    c2jItem = cm.Item({
        ...
        contentScriptFile: [data.url('coffeescript/extras/coffee-script.js'), data.url('convert.js'), data.url('convert-click.js')],
